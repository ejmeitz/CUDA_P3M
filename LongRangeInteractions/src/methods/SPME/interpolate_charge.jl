        ...
        for c0 in range(1,n)
            ...
            for c1 in range(1,n)
                ...
                for c2 in range(1,n)
                    ...
                    dQdr[i, 1, l0, l1, l2] = charges[i]*(K1*recip_lat[1,1]*dM0*M1*M2 + K2*recip_lat[2,1]*dM1*M0*M2 + K3*recip_lat[3,1]*dM2*M0*M1)
                    dQdr[i, 2, l0, l1, l2] = charges[i]*(K1*recip_lat[1,2]*dM0*M1*M2 + K2*recip_lat[2,2]*dM1*M0*M2 + K3*recip_lat[3,2]*dM2*M0*M1)
                    dQdr[i, 3, l0, l1, l2] = charges[i]*(K1*recip_lat[1,3]*dM0*M1*M2 + K2*recip_lat[2,3]*dM1*M0*M2 + K3*recip_lat[3,3]*dM2*M0*M1)
